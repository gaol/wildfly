...
public final class ResourceAdapterDeploymentService extends AbstractResourceAdapterDeploymentService implements
    ...
    public void start(StartContext context) throws StartException {
        ...
        ClassLoader deployCL = getClassLoader(context.getController().getServiceContainer(), classLoader, activation);
        final WildFLyRaDeployer raDeployer =
                new WildFLyRaDeployer(context.getChildTarget(), url, deploymentName, root, deployCL, cmd, activation, deploymentServiceName, fromModule);
        ...
        try {
            try {
                ...
                WildFlySecurityManager.setCurrentContextClassLoaderPrivileged(deployCL);
            ...
            cleanupStartAsync(context, deploymentName, t, duServiceName, deployCL);
        }
    }
